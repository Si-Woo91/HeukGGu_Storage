...
/*
 * public void solution(k, dungeons){
 * 		return;
 * }
 * 
 * dungeons[x][2] = {{최소피로도, 소모피로도}, {최소피로도, 소모피로도}, {최소피로도, 소모피로도}......}
 * 1<=k<=100  k : 현재피로도
 * 
 */
public class Game {
	public static void main(String[] args) {
		  Game g = new Game();
	        ...
	        System.out.println(g.solution(80, dungeons));
	    }
////////////////////////////////////////////////////////////////////////////
	    ...
	    public static void dfs(int k, int[][] dungeons, int cnt){
	        ...
	        answer = Math.max(cnt,answer);						// 입력 받은 값 중 가장 큰 숫자 반환
